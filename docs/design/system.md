...
- Spacing: a 4px base progression from 4–48px, responsive page gutters, a 1280px maximum management width, and a 704px reading width.
...
Management layouts use a persistent left navigation at tablet/desktop widths, bounded content width, compact page headings, tables, and contextual actions. Smaller widths use shallow horizontally scrollable navigation; the desktop sidebar is not merely squeezed onto a phone.
